...
RUN sed -i 's/Xms2g/Xms1g/' /home/elasticsearch/elasticsearch/config/jvm.options
RUN sed -i 's/Xmx2g/Xmx1g/' /home/elasticsearch/elasticsearch/config/jvm.options
